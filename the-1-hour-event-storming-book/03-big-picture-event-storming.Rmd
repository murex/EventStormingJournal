...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** _You might be wondering how to use Event Storming with legacy systems? You'll see that you need to forget the legacy and focus on the system\'s evolution instead._
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** _Let's take a Big Picture of the Big Picture Event Storming! Here is a summary of everything we wrote in this part, plus references to go deeper._
:::
