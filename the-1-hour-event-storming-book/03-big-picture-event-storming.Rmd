...
1. [The general goal](#big-picture--guide--what-to-say--why)
2. [The scope and use cases](#big-picture--guide--what-to-say--scope)
3. [What a domain event is](#big-picture--guide--what-to-say--domain-events)
4. [What a domain definition is](#big-picture--guide--what-to-say--ubiquitous-language)
5. [How to record questions and problems](#big-picture--guide--what-to-say--problems)
6. [And a few simple rules to ensure the success of the workshop](#big-picture--guide--what-to-say--last-things)
...
> #### Introduction: why and who {#big-picture--guide--what-to-say--why}
>
...
> #### Scope and use cases {#big-picture--guide--what-to-say--scope}
>
...
>
> #### Domain Events {#big-picture--guide--what-to-say--domain-events}
>
...
> #### Domain Definitions (aka [Ubiquitous Language](https://martinfowler.com/bliki/UbiquitousLanguage.html)) {#big-picture--guide--what-to-say--ubiquitous-language}
> 
...
> #### Problems {#big-picture--guide--what-to-say--problems}
> 
...
> 
> #### Last things to know before starting {#big-picture--guide--what-to-say--last-things}
> 
...
This phase should trigger intense discussions. Take the opportunity to nudge participants into capturing [domain definitions](#big-picture--guide--what-to-say--ubiquitous-language) and [problems](#big-picture--guide--what-to-say--problems) to look into. For example:
...
- [How to prepare the room for a Big-Picture Event Storming](#big-picture--room) lists all the supplies for the workshop:
  ...
  - A small table
  - Food.
- [What to say at the beginning of a Big-Picture Event Storming](#big-picture--guide--what-to-say) provides an example you can reuse.
