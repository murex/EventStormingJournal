...
If all these are true, try Big Picture Event Storming! Continue reading on [How to prepare a Big Picture Event Storming workshop](#big-picture--prepare) to be guided to start!
...
![Drawing of an actor post-it for Big Picture Event Storming. It's a small yellow post-it with the role written on and a stick figure drawn on.](./imgs/2022-02-22-step-by-step-guide-to-run-your-big-picture-event-storming/actor-post-it.png)
...
![Drawing of an external-system post-it for Big Picture Event Storming. It's a blue post-it with the external system's name written on.](./imgs/2022-02-22-step-by-step-guide-to-run-your-big-picture-event-storming/external-system-post-it.png)
...
### Three flavors of Bounded Contexts
...
![Zoom on a part of the Event Storming board where we can see a bounded context classified as core with a ❤️ post-it](./imgs/2022-10-29-decide-to-build-or-buy-with-big-picture-event-storming/a-core-functional-area.jpg)
...
-   [Do NOT try to Event Storm your Legacy!](#big-picture--further--do-not-event-storm-legacy)
-   [Start with a 30-minute brief](#big-picture--further--brief)
-   [Adapt the schedule even more than usual!](#big-picture--further--adapt-schedule)
-   [Make stress explicit](#big-picture--further--stress)
