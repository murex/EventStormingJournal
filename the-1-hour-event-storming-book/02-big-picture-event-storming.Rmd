...
If all these are true, try Big Picture Event Storming! Continue reading on [How to prepare a Big Picture Event Storming workshop] to be guided to start!
...
- [A Visual Agenda]
- [A long wall][Infinite Design Space]
- [A long strip of paper][Infinite Design Space]
- [Stickies]
- [Sharpies]
- [A Small Table]
- [Food](#food)
...
> ### Scope and use cases
>
> Today, you&#39;ll cover <[_your scope_][How to prepare a Big Picture Event Storming workshop]>. To make things more concrete, you&#39;ll explore the following use-cases <[_list your use cases_][How to prepare a Big Picture Event Storming workshop]>.
>
> ###  Domain Events
>
> You will start by identifying domain events that happen during these use-cases, such as <[_your 1st event_][How to prepare a Big Picture Event Storming workshop]>. A Domain Event is simply something that happens in your system.
> 
...
### Briefing and presenting the plan

**Now is the time to present the workshop to the participants. Start with the goal, scope, and use cases**. It&#39;s the right moment to explain the step participants will go through and how each step will help them to reach their end goal. A visual agenda helps a lot here. It&#39;s also an excellent time to introduce some general conventions. You can find a sample briefing script in [What to say at the beginning of a Big Picture Event Storming].
...
### Five reasons why a functional architecture will improve collaboration
...
This activity starts after all [the Big Picture Event Storming steps][Step by Step Guide to run your Big Picture Event Storming] we presented before. Your design board should look something like that:
...
If you want, you can decorate the Event Storming design board with ❤️, 🅖 and 🅢 stickies. Do you remember the context map we presented [Improve collaboration with a Functional Architecture vision draft]? You can also decorate this one!
