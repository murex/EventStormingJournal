...
::: {.lead-statement data-latex=""}
ℹ️ **In this chapter:** _Event Storming the flow workshop requires 5 main ingredients in the recipe. Get ready to cook in this chapter!_
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this chapter:** *In this chapter, you'll go beyond the linear view of workflows and uncover the power of feedback loops. learn how to model step-by-step processes with feedback loops, revealing new possibilities to rethink and redesign your workflow.*
:::
