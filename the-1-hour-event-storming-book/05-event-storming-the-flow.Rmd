...
ℹ️ **In this section:** _Event storming can be used to improve the flow of work. Answer 3 questions to know if the technique is your go-to choice to address your workflow challenges._
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** _Event Storming the flow workshop requires 5 main ingredients in the recipe. Get ready to cook in this chapter!_
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** _after modelling your workflow with Event Storming, you will use a metaphor to give a name to this model. This chapter explains how and why this is good practice._
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** *In this chapter, you'll go beyond the linear view of workflows and uncover the power of feedback loops. learn how to model step-by-step processes with feedback loops, revealing new possibilities to rethink and redesign your workflow.*
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** _Learn an easy and straightforward method to pinpoint key levers to improve your workflow._
:::
...
::: {.lead-statement data-latex=""}
ℹ️ **In this section:** _Discover how to set small, actionable steps to act upon the [levers](#flow--levers) identified in the previous chapter_
:::
