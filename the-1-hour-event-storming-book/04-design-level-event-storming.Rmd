...
Before getting [Alberto’s advice about logging decisions](#big-picture--guide--reverse-storytelling), we tried using custom “decision” stickies. That did not work well. Event Storming already has an extensive color code for stickies; adding more is too much. (Note: It’s almost impossible to find a sticky color that is not already used, anyway!)
