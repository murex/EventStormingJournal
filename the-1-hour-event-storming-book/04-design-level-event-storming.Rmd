...
> 💡 **Side Note: A DDD Aggregate is a small-scale programming pattern that recommends creating and destroying objects as grapes with a root.**
...
If you haven't run a Big Picture Event Storming before, as long as the previous checks are ok, Design Level Event Storming will work! You'll have to start with a fast "mini big picture event storming" on your scope. That's also a way to "redo" a quick Design Level Event Storming to adjust as you progress.
...
>💡 **Side Note: Design-Level Event Storming is the perfect workshop to discuss the UX of domain events**
...
>💡 **Side Note: Discussing Business Rules is the critical moment of Design-Level Event Storming**
...
>💡 **Side Note: These conversations can be an occasion to use other practical conversation formats like [Example Mapping](https://cucumber.io/blog/bdd/example-mapping-introduction/)**
...
>💡 Side Note: Finding good names for Aggregates is the last thing to do in a Design-Level Event Storming**
...
## Design Level Event Storming in 3 minutes {#design-level--3m}
...
**TODO** Or refine your understanding of the Bounded Context, for example,
    with the [Bounded Context Canvas](https://github.com/ddd-crew/bounded-context-canvas).
