...
The previous post ended with a key rule of remote facilitation: **“What is implicit must become explicit!”. As a facilitator, you must take the extra step to trigger collaboration that would naturally happen if people were co-located**. For example, you cannot bring beverages and food to the workshop and expect people to take some when needed. Instead, you’ll have to explicitly ask them to gather some at their desks from the beginning!
