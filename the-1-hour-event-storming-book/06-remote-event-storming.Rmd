...
::: {.lead-statement data-latex=""}
ℹ️ **In this chapter:** _Let's see how we can turn breaks between sessions into a workshop facilitation superpower._
:::

![Drawing of a cake written "Event Storm" that is cut in 2 parts. Chunking Event Storming into short sessions yields plenty of great benefits.](./imgs/2025-05-27-leverage-the-time-between-sessions-in-a-remote-event-storming/event-storming-cake.jpg)
...
![Photo of a construction worker taking a step back to review the work done. The end of every Event Storming session is the occasion to take a look at the raised problems, questions, and decisions.](./imgs/2025-05-27-leverage-the-time-between-sessions-in-a-remote-event-storming/worker-step-back.jpg)
...
1. **Tidy up the board!** [Keeping the board tidy](#remote-event-storming--7-pratices--tidy-board) is one of the seven fundamental remote facilitation practices. The time between the sessions is perfect for this.
...
![Photo of visitors walking around in a museum gallery. Start the Event Storming session by pairing people for a "Hot Beverage Gallery Walk" so that they reconnect with co-participants and what was done before.](./imgs/2025-05-27-leverage-the-time-between-sessions-in-a-remote-event-storming/gallery-walk.jpg)
...
![Photo of an agenda with daily notes. Keeping track of what happens during every Event Storming chunk is a cheap benefit of running sessions remotely.](./imgs/2025-05-27-leverage-the-time-between-sessions-in-a-remote-event-storming/daily-log.jpg)
...
The following chapter will be about keeping people engaged in a remote session.

## Remote Event Storming: Making Virtual Workshops Fun and Productive

::: {.lead-statement data-latex=""}
ℹ️ **In this chapter:** Let's look over practical tips to boost engagement and make virtual Event Storming both fun and productive._
:::

![Drawing of the hacked up remote robot with a poor participant who got a headache trying to follow an event storming session remotely. Remote workshops can be boring and exhausting, here are recipes to make it more fun and productive.](./imgs/2026-03-17-remote-event-storming-making-virtual-workshops-fun-and-productive/remote-event-storming-exhausted.jpg)
...
4.   Remind participants to keep webcams on and **[assign collaboration roles](#remote-event-storming--7-practices--collaboration-roles) in breakout rooms**.
...
6.   **Rely on [Silent Sorting](#remote-event-storming--7-practices--silent-sorting)** as much as possible to merge the outcomes from different rooms.
...
![Photo of a teapot and tea cups on a table. It's always good to prepare food and drinks for local "co-working and break hubs".](./imgs/2026-03-17-remote-event-storming-making-virtual-workshops-fun-and-productive/local-break-hub.jpg)
...
![Photo of a remote robot standing in the middle of a bright open space. We can see the face of a remote worker through the robot's screen. We tried something like this in an Event Storming workshop, but it was not successful.](./imgs/2026-03-17-remote-event-storming-making-virtual-workshops-fun-and-productive/remote-robot.jpg)

::: {.sidenote data-latex=""}
📝 **Anti-pattern: Adding A Single Remote Participant**

At some point, "remote-robots" were in fashion. We heard good feedback about them at a conference. So, we thought we could give it a try for Event Storming. The idea was:
...
![Photo of 2 hands bringing together 2 pieces of a puzzle. You now have all the pieces to run a successful remote Event Storming workshop.](./imgs/2026-03-17-remote-event-storming-making-virtual-workshops-fun-and-productive/puzzle.jpg)

This was our final chapter about facilitating remote Event Storming workshops. If you read all the others, you know everything you need to run great remote sessions. 
