...
## Simplify Remote Event Storming With 7 Essential Practices
...
## Your Step-by-Step Preparation Guide to Remote Event Storming

::: {.lead-statement data-latex=""}
ℹ️ **In this chapter:** _7 things to do to prepare a remote Event Storming. From logistics to pre-facilitation: follow these steps to set your workshop up for success!_
:::
...
If you feel ready, start preparing for your upcoming remote Event Storming! Otherwise, let's continue with a step-by-step walkthrough of the remote Event Storming workshop itself.
