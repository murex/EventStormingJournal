...
_Identify events on stickies to make sure they happen as you wish. This is what event storming is about. This first chapter is an overview of the technique and its benefits._
...
![The steps of my morning routine](./imgs/2021-06-18-essence-of-event-storming/MyMorningRoutine.jpg)
...
![The steps of my weekend](./imgs/2021-06-18-essence-of-event-storming/NextWeekEndWish.jpg)
...
![Iceberg with events at the top, bahavior at the bottom and structure below the surface](./imgs/2021-06-18-essence-of-event-storming/iceberg-3273216_640.jpg)
...
So let's have a look at some examples. Read on, we'll illustrate the above with short stories in which **Event Storming is used:**

1. **to improve a team's workflow**
2. **to draft a software design in details**

## Three Short stories to illustrate how event storming can be used
